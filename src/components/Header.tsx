    ...
    return (
        <header className="w-full p-2 flex bg-blue-950 items-center justify-between">
                ...
                <div className="w-64 h-[29px] flex items-center gap-16">
                    <Link to="/" className="text-white text-base font-bold font-16">Minha cabeceira</Link>
                    <Link to="/explore" className="text-white text-base font-normal font-sans">Explorar</Link>
                </div>
                <Link to="/profile">
