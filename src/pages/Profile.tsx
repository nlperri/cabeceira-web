                ...
                <main className="flex-1 flex flex-col items-center mt-[150px] font-[Content]">
                    <div className="w-[70%] flex flex-col ">
                        <div className="flex  justify-between items-center">
                            ...
                            <p onClick={handleUpdateModal} className="text-rose-400 hover:text-rose-300 cursor-pointer text-xs font-bold">Editar perfil</p>
                        </div>
                        ...
                        <div onClick={logout} className="mt-32 mb-4 self-center w-[50%] max-w-[300px] p-2 text-center bg-white rounded-lg border border-rose-400 text-rose-400 text-[13px] font-bold hover:bg-pink-salmon hover:text-white cursor-pointer">Sair</div>

                    </div>
                </main>
                {openUpdateModal && <UpdateUserModal user={user} handleUpdateModal={handleUpdateModal} />}
            </div>
        )
